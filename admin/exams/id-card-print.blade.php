    ...
    <div class="card-container">
        ...
        <div class="exam-card">
            ...
            <div class="exam-card-header">
                ...
                <img class="school-logo" src="{{ asset('storage/' . $school->logo) }}" alt="Logo">
                @else
                ...
                <div class="header-text">
                    ...
                    <div class="exam-title">{{ $exam->name }} — {{ strtoupper($exam->type) }} — {{ $exam->subject->name ?? '' }}</div>
                </div>
            </div>
            ...
            <div class="exam-card-body">
                <div class="exam-card-left">
                    ...
                    <div class="data-row">
                        ...
                        <span class="value highlight">{{ $student->user->name }}</span>
                    </div>
                    <div class="data-row">
                ...
                <div class="exam-card-center">
                    <div class="photo" style="background: {{ $avatarBg }};">
                        @if($photoUrl)
                ...
                <div class="exam-card-right">
                    <div class="schedule-row">
                        ...
                        <div class="value">{{ $exam->date ? $exam->date->isoFormat('dddd, D MMMM Y') : '-' }}</div>
                    </div>
                    <div class="schedule-row">
                        <div class="label">Jam</div>
                        <div class="value">{{ $exam->start_time ? substr($exam->start_time, 0, 5) : '-' }} - {{ $exam->end_time ? substr($exam->end_time, 0, 5) : '-' }} WIB</div>
                    </div>
                    <div class="schedule-row">
            ...
            <div class="exam-card-footer">
                ...
                <div class="barcode-area">
                    <div>
                        ...
                        <div class="barcode-text">{{ $noPeserta }}{{ $exam->id }}</div>
                    </div>
                </div>
                <div class="signature-col">
