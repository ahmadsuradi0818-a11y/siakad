        ...
        <div class="d-flex align-items-center gap-3 mb-4">
            ...
            <div>
                <h3 class="fw-bold mb-1" style="color: #1e293b;">
                    <i class="fas fa-plus-circle me-2" style="color: #fa709a;"></i>Buat Pengumuman
                </h3>
                <p class="text-muted mb-0 small">Bagikan informasi kepada siswa.</p>
            </div>
        </div>
            ...
            <div class="card-body p-4">
                <form action="{{ route('admin.announcements.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="title" class="form-control @error('title') is-invalid @enderror" placeholder="Judul pengumuman..." value="{{ old('title') }}" required>
                        @error('title')<div class="invalid-feedback">{{ $message }}</div>@enderror
                    </div>
                    <div class="mb-3">
                        <label class="form-label fw-semibold"><i class="fas fa-align-left text-secondary me-1"></i> Isi Pengumuman</label>
                        <textarea name="content" class="form-control @error('content') is-invalid @enderror" rows="10" placeholder="Tulis isi pengumuman di sini..." required>{{ old('content') }}</textarea>
