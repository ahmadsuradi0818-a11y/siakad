...
<div class="container-fluid px-3 px-md-4">
    ...
    <div class="d-flex align-items-center justify-content-between mb-4 flex-wrap gap-2">
        <div class="d-flex align-items-center gap-3">
            <div class="rounded-circle d-flex align-items-center justify-content-center text-white fw-bold shadow-sm flex-shrink-0" style="width: 48px; height: 48px; font-size: 1.1rem; background: <?php echo e($avatarColor); ?>;">
                <?php echo e(strtoupper(substr(auth()->user()->name, 0, 1))); ?>

            </div>
            <div>
                <h4 class="fw-bold mb-0" style="color: #1e293b;"><?php echo e($greeting); ?>, <?php echo e(explode(' ', auth()->user()->name)[0]); ?>!</h4>
                <p class="text-muted small mb-0">
                    <i class="fas fa-calendar-alt me-1"></i><?php echo e(now()->translatedFormat('l, d F Y')); ?>
            ...
            <div class="card border-0 rounded-3 h-100 overflow-hidden" style="background: linear-gradient(135deg, #667eea, #764ba2); box-shadow: 0 4px 15px rgba(102,126,234,0.25);">
                <div class="card-body p-3 p-md-4 position-relative">
                    ...
                    <div class="position-relative">
                        ...
                        <h3 class="fw-bold text-white mb-0 fs-2"><?php echo e($totalSiswa); ?></h3>
            ...
            <div class="card border-0 rounded-3 h-100 overflow-hidden" style="background: linear-gradient(135deg, #43e97b, #38f9d7); box-shadow: 0 4px 15px rgba(67,233,123,0.25);">
                <div class="card-body p-3 p-md-4 position-relative">
                    ...
                    <div class="position-relative">
                        ...
                        <h3 class="fw-bold text-white mb-0 fs-2"><?php echo e($totalGuru); ?></h3>
            ...
            <div class="card border-0 rounded-3 h-100 overflow-hidden" style="background: linear-gradient(135deg, #4facfe, #00f2fe); box-shadow: 0 4px 15px rgba(79,172,254,0.25);">
                <div class="card-body p-3 p-md-4 position-relative">
                    ...
                    <div class="position-relative">
                        ...
                        <h3 class="fw-bold text-white mb-0 fs-2"><?php echo e($totalKelas); ?></h3>
            ...
            <div class="card border-0 rounded-3 h-100 overflow-hidden" style="background: linear-gradient(135deg, #f093fb, #f5576c); box-shadow: 0 4px 15px rgba(245,87,108,0.25);">
                <div class="card-body p-3 p-md-4 position-relative">
                    ...
                    <div class="position-relative">
                        ...
                        <h3 class="fw-bold text-white mb-0 fs-2"><?php echo e($totalHadir); ?>/<?php echo e($presensiHariIni); ?></h3>
                        <p class="text-white-50 small mb-0">Hadir Hari Ini</p>
                        <?php if($presensiHariIni > 0): ?>
                        <div class="progress mt-2" style="height: 4px; background: rgba(255,255,255,0.2); border-radius: 2px;">
                            <div class="progress-bar bg-white rounded-pill" style="width: <?php echo e(($totalHadir / max($presensiHariIni, 1)) * 100); ?>%;"></div>
                        </div>
                        <?php endif; ?>
                    </div>
                </div>
    ...
    <div class="row g-3 mb-4">
        <div class="col-lg-5">
            <div class="card border-0 shadow-sm rounded-3 h-100">
                <div class="card-header bg-white border-0 pt-3 px-3 px-md-4 d-flex align-items-center justify-content-between">
                    ...
                    <span class="small text-muted"><?php echo e(array_sum($chartPresensiHariIni)); ?> total</span>
                </div>
                <div class="card-body pt-2 px-3 px-md-4 d-flex align-items-center justify-content-center" style="min-height: 240px;">
                    <div class="position-relative d-inline-block">
                        ...
                        <div class="position-absolute top-50 start-50 translate-middle text-center">
                            <span class="fw-bold d-block" style="color: #1e293b; font-size: 1.4rem;"><?php echo e($presensiHariIni > 0 ? round(($totalHadir / $presensiHariIni) * 100) : 0); ?>%</span>
                ...
                <div class="card-footer bg-white border-top-0 px-3 px-md-4 pb-3 pt-0">
                    <div class="d-flex justify-content-center gap-3 flex-wrap">
                        <span class="small d-flex align-items-center gap-1"><span class="rounded-circle d-inline-block" style="width: 8px; height: 8px; background: #22c55e;"></span> Hadir <?php echo e($chartPresensiHariIni['hadir']); ?></span>
                        <span class="small d-flex align-items-center gap-1"><span class="rounded-circle d-inline-block" style="width: 8px; height: 8px; background: #f59e0b;"></span> Sakit <?php echo e($chartPresensiHariIni['sakit']); ?></span>
                        <span class="small d-flex align-items-center gap-1"><span class="rounded-circle d-inline-block" style="width: 8px; height: 8px; background: #3b82f6;"></span> Izin <?php echo e($chartPresensiHariIni['izin']); ?></span>
                        <span class="small d-flex align-items-center gap-1"><span class="rounded-circle d-inline-block" style="width: 8px; height: 8px; background: #ef4444;"></span> Alpha <?php echo e($chartPresensiHariIni['alpha']); ?></span>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-lg-7">
            <div class="card border-0 shadow-sm rounded-3 h-100">
                <div class="card-header bg-white border-0 pt-3 px-3 px-md-4 d-flex align-items-center justify-content-between">
                    <h5 class="fw-bold mb-0" style="color: #1e293b; font-size: 0.95rem;"><i class="fas fa-chart-bar me-2 text-success"></i>Presensi Per Bulan (<?php echo e(now()->year); ?>)</h5>
                </div>
                <div class="card-body pt-2 px-3 px-md-4">
                    <?php if($presensiPerBulan->isNotEmpty()): ?>
        ...
        <div class="col-lg-6">
            <div class="card border-0 shadow-sm rounded-3 h-100">
                <div class="card-header bg-white border-0 pt-3 px-3 px-md-4 d-flex align-items-center justify-content-between">
                    ...
                    <span class="badge bg-warning bg-opacity-10 text-warning rounded-pill small fw-normal"><?php echo e($jadwalUjian->count()); ?> ujian</span>
                </div>
                <div class="card-body px-3 px-md-4">
                    <?php echo $__env->make('components.calendar', ['examDates' => $examDates, 'month' => $month, 'year' => $year, 'route' => 'admin.dashboard'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                </div>
                <?php if($jadwalUjian->isNotEmpty()): ?>
                <div class="card-footer bg-white border-top-0 px-3 px-md-4 pb-3">
                    ...
                    <?php $__currentLoopData = $jadwalUjian->take(4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ujian): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="d-flex align-items-center justify-content-between py-2 border-bottom border-light">
                        <div class="d-flex align-items-center gap-2 min-width-0">
                            ...
                            <div class="min-width-0">
                                <span class="fw-semibold small d-block text-truncate" style="color: #1e293b; max-width: 220px;"><?php echo e($ujian->name); ?></span>
                                <small class="text-muted d-flex align-items-center gap-1" style="font-size: 0.65rem;">
                                    <i class="fas fa-school"></i><?php echo e($ujian->class?->name); ?>

                                    <span class="mx-1">&middot;</span>
                                    <i class="fas fa-chalkboard"></i><?php echo e($ujian->teacher?->name); ?>

                                </small>
                            </div>
                        </div>
                        <span class="badge bg-light text-muted rounded-pill fw-normal small flex-shrink-0"><?php echo e($ujian->date->format('d/m')); ?></span>
                    </div>
                ...
                <div class="card-body p-0">
                    <div class="table-responsive">
                        <table class="table align-middle mb-0">
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $presensiPerBulan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <?php
                                ...
                                <tr class="border-bottom border-light">
                                    <td class="px-4 py-3">
                                        <span class="fw-semibold d-flex align-items-center gap-2" style="color: #0f172a; font-size: 0.88rem;">
                                            <span style="width: 8px; height: 8px; border-radius: 50%; background: <?php echo e($monthColors[$loop->index % 12]); ?>; display: inline-block;"></span>
                                            <?php echo e(\Carbon\Carbon::create()->month($data->bulan)->format('F')); ?>

                                        </span>
                                    </td>
                                    <td class="px-3 py-3 text-center"><span class="badge bg-success bg-opacity-10 text-success rounded-pill fw-semibold px-3"><?php echo e($data->hadir); ?></span></td>
                                    <td class="px-3 py-3 text-center"><span class="badge bg-warning bg-opacity-10 text-warning rounded-pill fw-semibold px-3"><?php echo e($data->sakit); ?></span></td>
                                    <td class="px-3 py-3 text-center"><span class="badge bg-primary bg-opacity-10 text-primary rounded-pill fw-semibold px-3"><?php echo e($data->izin); ?></span></td>
                                    <td class="px-3 py-3 text-center"><span class="badge bg-danger bg-opacity-10 text-danger rounded-pill fw-semibold px-3"><?php echo e($data->alpha); ?></span></td>
                                    <td class="px-4 py-3 text-center"><span class="fw-bold" style="color: #0f172a;"><?php echo e($data->total); ?></span></td>
                                </tr>
...
document.addEventListener('DOMContentLoaded', function () {
    var presensiTotal = <?php echo e(array_sum($chartPresensiHariIni)); ?>;
    ...
    if (ctx && presensiTotal > 0) {
        new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    data: [<?php echo e($chartPresensiHariIni['hadir']); ?>, <?php echo e($chartPresensiHariIni['sakit']); ?>, <?php echo e($chartPresensiHariIni['izin']); ?>, <?php echo e($chartPresensiHariIni['alpha']); ?>],
    ...
    if (bulanCtx) {
        var bulanLabels = <?php echo json_encode($presensiPerBulan->map(fn($d) => \Carbon\Carbon::create()->month($d->bulan)->format('M')), 15, 512) ?>;
        var bulanHadir = <?php echo json_encode($presensiPerBulan->pluck('hadir'), 15, 512) ?>;
        var bulanSakit = <?php echo json_encode($presensiPerBulan->pluck('sakit'), 15, 512) ?>;
        var bulanIzin = <?php echo json_encode($presensiPerBulan->pluck('izin'), 15, 512) ?>;
        var bulanAlpha = <?php echo json_encode($presensiPerBulan->pluck('alpha'), 15, 512) ?>;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\siakad\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>