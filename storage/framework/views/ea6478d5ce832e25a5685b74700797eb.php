...
<div class="row mb-4">
    <div class="col-12 d-flex align-items-stretch">
        <div class="card card-primary card-outline w-100">
                ...
                <div class="row mb-3 align-items-center">
                    ...
                    <div class="col-md-6 text-md-end mt-2 mt-md-0">
                        <span class="text-muted small">
                            <i class="fas fa-layer-group me-1"></i> Total: <strong><?php echo e($classes->total() ?? $classes->count()); ?></strong> kelas
                        </span>
                    </div>
                </div>
                            ...
                            <tr class="align-middle">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0 me-3">
                                            <div class="rounded-circle d-flex align-items-center justify-content-center" style="width: 42px; height: 42px; background: linear-gradient(135deg, #667eea22, #764ba222); color: #667eea; font-weight: 700; font-size: 14px;">
                                                <?php echo e(substr($class->name, 0, 2)); ?>
                                    ...
                                    <?php if($class->homeroomTeacher): ?>
                                        <div class="d-flex align-items-center">
                                            <div class="rounded-circle bg-secondary d-flex align-items-center justify-content-center text-white me-2" style="width: 34px; height: 34px; font-size: 13px; font-weight: 600;">
                                                <?php echo e(substr($class->homeroomTeacher->name, 0, 1)); ?>

                                            </div>
                                            <span><?php echo e($class->homeroomTeacher->name); ?></span>
                                        </div>
                                    <?php else: ?>
                                ...
                                <td class="text-center">
                                    <span class="badge bg-info bg-opacity-10 text-info rounded-pill px-3 py-2 fw-normal">
                                        <i class="fas fa-user-graduate me-1"></i> <?php echo e($class->students->count()); ?>
                                ...
                                <td class="text-center">
                                    <div class="d-flex justify-content-center gap-1">
                                        <button type="button"
                                            ...
                                            data-url="<?php echo e(route('admin.classes.update', $class)); ?>"
                                            data-name="<?php echo e($class->name); ?>"
                                            data-teacher="<?php echo e($class->homeroom_teacher_id); ?>">
                                        ...
                                        <button type="button"
                                            ...
                                            data-url="<?php echo e(route('admin.classes.destroy', $class)); ?>"
                                            data-name="<?php echo e($class->name); ?>">
            ...
            <?php if(method_exists($classes, 'links') && $classes->hasPages()): ?>
...
<div class="modal fade" id="createModal" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <form action="<?php echo e(route('admin.classes.store')); ?>" method="POST" class="modal-content shadow">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\siakad\resources\views/admin/classes/index.blade.php ENDPATH**/ ?>